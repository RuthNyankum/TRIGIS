...
//                     onChange={handleOnChange}
//                     required
//                     className="w-full px-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl outline-none focus:border-purple-500 focus:bg-white transition-all duration-300 font-inter appearance-none cursor-pointer"
//                   >
...
const SignUp = () => {
  ...
  //     setTimeout(() => {
  //       navigate("/login");
  //     }, 1500); // 1.5 seconds delay so the toast can show
  //   } catch (error) {
  //     console.error("Signup error:", error.response?.data || error.message);
  //     toast.error(
  //       error.response?.data?.message || "Signup failed. Please try again."
