        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 animate-fadeInUp">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto font-inter leading-relaxed">
              Transforming academic and professional journeys through
              high-quality writing services that inspire success, ensure
              originality, and uphold excellence.
            </p>
          </div>
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
                <div>
                  ...
                  <div className="space-y-6 text-gray-700 font-inter leading-relaxed">
                    <p className="text-lg">
                      Founded in 2019 with a simple yet powerful mission: to
                      help businesses communicate more effectively through
                      compelling content and strategic storytelling.
                    </p>
                    <p>
                      ...
                      well-researched, original, and structured academic
                      projects with precision and consistency.
                    </p>
                    <p>
                      Beyond academic work, we also support students,
                      researchers, and professionals with CVs, proposals,
                      essays, dissertations, and business writing — ensuring
                      clarity, professionalism, and results. Our mission is to
                      make your academic and career journey easier by offering
                  ...
                  <div className="gradient-bg rounded-2xl p-8 text-white">
                    <div className="text-center">
                      ...
                      <p className="text-lg font-inter leading-relaxed">
                        ...
                        well-structured academic and professional writing
                        services that support academic success, career growth,
                ...
                <div className="grid lg:grid-cols-2 gap-12 mb-16">
                  ...
                  <div className="bg-white rounded-2xl p-8 shadow-lg">
                    ...
                    <p className="text-gray-700 font-inter text-lg leading-relaxed">
                      ...
                      continuously raise industry standards through innovation
                      and excellence.
                    </p>
                  </div>
                </div>
            ...
            <div className="animate-fadeInUp">
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
                ...
                <div>
                  ...
                  <div className="space-y-6 text-gray-700 font-inter leading-relaxed">
                    <p className="text-lg">
                      Agnes Gyesi is a multifaceted individual who has made a
                      name for herself as a writer, researcher, and
                      entrepreneur. With a degree in English , Diploma in
                      Research Skills and knowledge in tricology, she has
                      authored two notable books: "Hair Elegance: The Art of
                      Hair Care" and "Biblical Marriage: Love, Respect, and
                      Submission".
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      data visualization tools such as SPSS, Nvivo, and Power
                      BI, making her a valuable asset in research and
