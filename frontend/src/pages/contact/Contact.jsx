...
//                 Why Choose <span className="gradient-text">TRIGIS Consult</span>
//               </h3>
...
//                       Most projects start within 24-48 hours with quick delivery
//                       times
//                     </p>
//                   </div>
//                 </div>
...
//                 <div className="flex items-start">
//                   <FaHandshake className="text-blue-500 mt-1 mr-4" size={20} />
//                   <div>
//                     <h4 className="font-semibold font-inter text-gray-900 mb-2">
//                       Dedicated Support
//                     </h4>
  ...
  const contactMethods = [
    {
      ...
      title: "Email Us",
      subtitle: "Quick response guaranteed",
      value: "gyesiagnes22@gmail.com",
      action: "mailto:gyesiagnes22@gmail.com",
      color: "purple",
      description: "Get a response within 2 hours during business hours",
    },
    {
      ...
      title: "Call Us",
      subtitle: "Direct line to our team",
      value: "+233 54 378 113",
      action: "tel:+233 54 378 113",
      color: "blue",
      description: "Monday - Friday, 9:00 AM - 6:00 PM GMT",
    },
    {
      ...
      subtitle: "Chat with us instantly",
      value: "+233 54 378 113",
      action: "https://wa.me/23354378113",
      color: "green",
      description: "Quick questions and instant support",
    },
    {
      ...
      action: "#",
      color: "red",
      description: "Cape coast, Central Region",
    },
  ];
