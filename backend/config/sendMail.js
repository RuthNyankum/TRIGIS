...
//     const msg = {
//       to,
//       from: process.env.ADMIN_EMAIL || "no-reply@trigisconsult.com",
//       subject,
//       html,
//     };
...
//         <div style="background-color: #f9fafb; padding: 15px; border-radius: 8px; margin: 20px 0;">
//           <h4 style="color: #374151; margin-top: 0;">📊 Additional Info</h4>
//           <p style="font-size: 13px; color: #6b7280; margin: 5px 0;"><strong>Submission ID:</strong> ${
//             contact._id
//           }</p>
//           <p style="font-size: 13px; color: #6b7280; margin: 5px 0;"><strong>Submitted:</strong> ${new Date(
//             contact.createdAt
//           ).toLocaleString()}</p>
//           <p style="font-size: 13px; color: #6b7280; margin: 5px 0;"><strong>IP Address:</strong> ${
//             contact.ipAddress || "N/A"
//           }</p>
//         </div>
//         <div style="text-align: center; margin-top: 30px;">
//           <a href="${
//             process.env.ADMIN_DASHBOARD_URL || "http://localhost:5173/admin"
//           }/contacts/${contact._id}"
//              style="display: inline-block; background: linear-gradient(to right, #7c3aed, #eab308); color: white; padding: 12px 30px; text-decoration: none; border-radius: 8px; font-weight: bold;">
//             View in Dashboard
//           </a>
...
//       </div>
//       <div style="padding: 30px; background-color: #ffffff; border: 1px solid #e5e7eb; border-top: none;">
//         <h2 style="color: #374151; margin-top: 0;">Thank You, ${contact.firstName}! 🎉</h2>
//         <p style="color: #6b7280; line-height: 1.8; font-size: 15px;">
//           We've received your message and appreciate you reaching out to us.
//           Our team is excited to learn more about your project and help you achieve your goals.
//         </p>
//         <!-- You can keep the rest of your HTML content as is -->
//       </div>
//     </div>
//   `;
...
export const sendMail = async ({ to, subject, html }) => {
  try {
    await transporter.sendMail({
      from: `"TRIGIS Consult" <no-reply@trigisconsult.com>`,
      to,
      subject,
      html,
    });
...
export const sendAdminNotification = async (contact) => {
  const html = `
    ...
    contact.email
        ...
        <div style="text-align: center; margin-top: 30px;">
          <a href="${process.env.ADMIN_DASHBOARD_URL}/contacts/${contact._id}" 
             style="display: inline-block; background: linear-gradient(to right, #7c3aed, #eab308); color: white; padding: 12px 30px; text-decoration: none; border-radius: 8px; font-weight: bold;">
            View in Dashboard
          </a>
        </div>
...
export const sendClientAutoReply = async (contact) => {
  ...
  <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
    ...
    <div style="padding: 30px; background-color: #ffffff; border: 1px solid #e5e7eb; border-top: none;">
      ...
      <p>Meanwhile, check our <a href="${
        process.env.WEBSITE_URL
      }" style="color:#7c3aed">website</a> for resources.</p>
    </div>
    <div style="padding: 20px; background-color: #f9fafb; border-radius: 0 0 8px 8px; text-align: center;">
      <p style="color: #6b7280; font-size: 12px; margin: 5px 0;">© ${new Date().getFullYear()} TRIGIS Consult. All rights reserved.</p>
    </div>
  </div>
  `;
